...
#ref from https://github.com/jiesutd/NCRFpp
...
class CRF(nn.Module):
    ...
    def __init__(self, tagset_size, gpu=None):
        ...
        init_transitions[0,:] = -10000.0
        if self.gpu:
            init_transitions = init_transitions.to(self.gpu)
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        if self.gpu:
            decode_idx = decode_idx.to(self.gpu)
